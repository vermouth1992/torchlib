...
def get_nets(env, args):
    ...
    if len(env.observation_space.shape) == 1:
        ...
        if env.observation_space.shape[:2] == (84, 84):
            ...
            from tensorlib.drl.models.policy import AtariPolicy

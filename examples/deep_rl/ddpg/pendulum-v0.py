...
if __name__ == '__main__':
    ...
    actor = ActorModule(state_dim=state_dim, action_dim=action_dim, action_bound=action_bound)
    actor_optimizer = torch.optim.Adam(actor.parameters(), lr=1e-4)
    critic = CriticModule(state_dim=state_dim, action_dim=action_dim)
    ...
    ddpg_model = Trainer(env, actor, critic, actor_noise, config)
    checkpoint_path = './checkpoint/pendulum-v0.ckpt'

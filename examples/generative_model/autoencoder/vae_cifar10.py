...
from torchlib.generative_model.autoencoder.utils import SampleImage
...
class Encoder(nn.Module):
    def __init__(self, code_size):
        ...
        self.model = nn.Sequential(
            *conv2d_bn_lrelu_block(3, 32, 4, 2, 1),
...
class Decoder(nn.Module):
    def __init__(self, code_size):
        ...
        self.model = nn.Sequential(
            *conv2d_trans_bn_lrelu_block(32, 32, kernel_size=4, stride=2, padding=1),
            *conv2d_trans_bn_lrelu_block(32, 32, kernel_size=4, stride=2, padding=1),
            *conv2d_trans_bn_lrelu_block(32, 3, kernel_size=4, stride=2, padding=1),
            nn.Sigmoid()
        )
...
if __name__ == '__main__':
    ...
    if train:
        ...
        train_data_loader = get_cifar10_data_loader(train=True, transform=transform)

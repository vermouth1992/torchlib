...
from torchlib.generative_model.autoencoder.aae.aae.aae import AAE
from torchlib.generative_model.autoencoder.aae.aae.aae_trainer import Trainer
...
from torchlib.utils.random.sampler import GaussianSampler
...
if __name__ == '__main__':
    ...
    lr_D = 2e-4
    lr_G = 2e-4
    checkpoint_path = './checkpoint/aae_mnist.ckpt'
    weight_norm = None
    alpha = 0.001
    ...
    gan_model = AAE(generator, decoder, discriminator, optimizer_G, optimizer_D, code_size, validity_loss_f,
